...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2024 at 08:46 AM
...
(2, 'contact', '0777169043'),
(2, 'email', 'yasanthadilshan3600@gmail.com'),
(2, 'address', 'Nature\'s Grow, 96, Mahara'),
(2, 'vehicle_name', 'Car'),
(2, 'vehicle_registration_number', '123'),
(2, 'vehicle_model', '123'),
(2, 'service_id', '3,2'),
(2, 'pickup_address', ''),
...
(1, 'Mike Williams', 3, 'Pick Up', 2, 4, '2021-09-30 14:48:57'),
(2, 'Yasantha', 1, 'Drop Off', NULL, 0, '2024-03-16 21:35:25');
